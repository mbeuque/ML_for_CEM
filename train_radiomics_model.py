...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_dir_features', required=True, help='Path to the directory to load/save the features')
    ...
    df_features_train.drop("outcome", inplace=True)
    ...
    df_features_test.drop("outcome", inplace=True)
